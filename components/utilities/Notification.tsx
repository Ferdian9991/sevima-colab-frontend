  ...
  return (
    ...
    >
      <div tw="px-3 py-4">
        <i
          className={
            LEVEL_ICON[notificationState?.type as keyof typeof LEVEL_ICON]
          }
        />{" "}
...
export const InlineNotificationCard = () => {
  ...
  return (
    <div tw="p-4">
      <div
        className={LEVEL_twS[notificationState?.type as keyof typeof LEVEL_twS]}
        tw="flex w-full px-4 justify-between border border-b-4 rounded-md"
      >
        <div tw="px-3 py-4">
          <i
            className={
              LEVEL_ICON[notificationState?.type as keyof typeof LEVEL_twS]
            }
          />
          {notificationState?.message}
        </div>
