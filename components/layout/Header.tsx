...
const Header = ({ sidebarOpen, setSidebarOpen, userLogin, title }: any) => {
  const [searchModalOpen, setSearchModalOpen] = useState(false);
  const authState = useSelector((state: any) => state.creds.userLogin);

  return (
    <header tw="sticky top-0 z-30">
      <div tw="px-4 bg-zircon-500 sm:px-6 lg:px-8">
