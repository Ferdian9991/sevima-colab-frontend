...
const ListView = () => {
  return (
    <div className="col-span-full xl:col-span-6 bg-white shadow-lg rounded-lg border border-slate-200">
      <header className="px-5 py-4 border-b border-slate-100">
        <h2 className="font-semibold text-slate-800">Platform Kami</h2>
      </header>
      <div className="p-3">
        {/* Table */}
        <div className="overflow-x-auto">
          <table className="table-auto w-full">
            ...
            <thead className="text-xs uppercase text-slate-400 bg-slate-50 rounded-sm">
              <tr>
                <th className="p-2">
                  <div className="font-semibold text-left">Sumber</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">Pengunjung</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">Pemghasilan</div>
                </th>
                <th className="p-2">
